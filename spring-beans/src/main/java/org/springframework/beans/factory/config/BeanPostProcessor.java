 ...
 *  4、CommonAnnotationBeanPostProcessor   处理公共的注解 @PostConstruct
 *  5、AutowiredAnnotationBeanPostProcessor
 *  6、RequiredAnnotationBeanPostProcessor
 *  7、BeanValidationPostProcessor
 *  8、AbstractAutoProxyCreator
 *  9、BeanPostProcessorChecker 当spring的配置中的后置处理器还没有被注册就已经开始了bean的初始化，便会打印BeanPostProcessorChecker中的一条消息
 *  ......
 *
 *
 ...
 */
public interface BeanPostProcessor { // bean后置处理器
